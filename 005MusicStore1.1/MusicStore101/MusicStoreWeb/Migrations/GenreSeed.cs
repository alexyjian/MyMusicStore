    ...
    public class GenreSeed
    {
        ...
        public static void Seed()
        {
            ...
            new List<Album>
            {
                ...
                new Album { Title ="同桌的你",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="老狼"),AlbumArtUrl="/Content/Images/LLprint1.jpg"},
                new Album { Title ="青春在见",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="老狼"),AlbumArtUrl="/Content/Images/LLprint2.jpg"},
                new Album { Title ="在路上",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="老狼"),AlbumArtUrl="/Content/Images/LLprint3.jpg"},
                new Album { Title ="米店",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="老狼"),AlbumArtUrl="/Content/Images/LLprint4.jpg"},
                new Album { Title ="礼物",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="老狼"),AlbumArtUrl="/Content/Images/LLprint5.jpg"},
                new Album { Title ="风起时，想你",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="陈楚生"),AlbumArtUrl="/Content/Images/LLprint6.jpg"},
                new Album { Title ="我知道你离我不远",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="陈楚生"),AlbumArtUrl="/Content/Images/LLprint7.jpg"},
                new Album { Title ="自己的太阳",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="陈楚生"),AlbumArtUrl="/Content/Images/LLprint8.jpg"},
                new Album { Title ="醉",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="陈楚生"),AlbumArtUrl="/Content/Images/LLprint9.jpg"},
                new Album { Title ="一夜知秋",Genre = genres.Single(g =>g.Name =="爵士"),Price = 8.99M,Artist = artists.Single(a =>a.Name =="陈楚生"),AlbumArtUrl="/Content/Images/LLprint10.jpg"},

    ...
    public class GenreSeed
    {
        ...
        public static void Seed()
        {
            ...
            var artists = new IList<Artist>()
            {
                ...
                new Artist() {Name = "徐靖博",Sex = false,Description ="徐靖博，男，营口市人。2003年毕业于中央戏剧学院表演系，著名歌手，音乐制作人。成名代表作:《分手那天》个人单曲《回来我的爱》获得"中国音乐联播榜"冠军。，男，营口市人。2003年毕业于中央戏剧学院表演系，著名歌手，音乐制作人。成名代表作:《分手那天》个人单曲《回来我的爱》获得"中国音乐联播榜"冠军。2001年以主演日剧《新宿伤痕恋歌》及演唱单曲《STARS》同时出道。2002年获得日剧学院赏最佳新人奖。2003年主演电影《偶遇极恶少年》。" },
            ...
            var albums = new List<Album>()
            {
                ...
                Artist = artists.Single(a => a.Name == "欢子"),AlbumAetUrl = "/Content/lmages/placeholder.gif"
            },
                 new Album
            {
                Title = "A Copland Celebration,Vol.l",Genre = genres.Single(g =>g.Name =="古典"),
                Price = 8.99M,Artist = artists.Single(a => a.Name == "欢子"),
                AlbumAetUrl = "/Content/lmages/placeholder.gif"
            },
               new Album
                {
                ...
                Artist = artists.Single(a => a.Name == "欢子"),AlbumAetUrl = "/Content/lmages/placeholder.gif"
                  ...
                  new Album
                {
                Title = "For Those About To Rock We Salute You",Genre = genres.Single(g =>g.Name =="摇滚"),Price = 8.99M,
                Price = 8.99M,Artist = artists.Single(a => a.Name == "欢子"),
                AlbumAetUrl = "/Content/lmages/placeholder.gif"
            },
          };

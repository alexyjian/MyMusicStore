...
using static MusicStoreEntity.EntityDbContexts;
...
namespace MusicStoreEntity.UserAndRole
{
    ...
    public class IdentityManager
    {
        ...
        {
            var rm = new RoleManager<ApplicationRole>(new RoleStore<ApplicationRole>(new EntityDbContexts.EntityDbContext()));
        ...
        {
            var um = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new EntityDbContexts.EntityDbContext()))
            {
        ...
        public bool CreateUser(ApplicationUser user, string password, EntityDbContexts.EntityDbContext dbContext)
        {

...
namespace MusicStore.Controllers
{
    public class StoreController : Controller
    {
        ...
        //    var reply = _context.Plaries.Find(id);
        ...
        //            var cmts = _context.Plaries.Where(x => x.Album.ID == reply.Album.ID).OrderByDescending(x => x.CreateDateTime).ToList();
        //            status.Html = _GetHtml(cmts);
        //            return Json(status);
        //        }
        //        else
        //        {
        //            var cmts = _context.Plaries.Where(x => x.ReplyPlaries.ID == reply.ParentReply.ID).OrderByDescending(x => x.CreateDateTime).ToList();
        //            //原回复
        //            var pcmt = _context.Plaries.Find(reply.ParentReply.ID);
        //            var htmlString = "";

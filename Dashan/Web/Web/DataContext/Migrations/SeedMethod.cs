...
namespace DataContext.Migrations
{
   public class SeedMethod
    {
        public static void CategoryProductSeed(ProductDbContext context)
        {
            var c1 = new Category()
            {
                Name = "家用电器",
            ...
            for(var i=0;i<200;i++)
            {
                var p1 = new Product()
                {
                    ...
                    DSCN = c1.Name + i.ToString("00") + "是真的好耶！",
            ...
            for (var i = 0; i < 50; i++)
            {
                var p2 = new Product()
                {
                    ...
                    DSCN = c2.Name + i.ToString("00") + "是真的好耶！",
            ...
            for (var i = 0; i < 80; i++)
            {
                var p3 = new Product()
                {
                    ...
                    DSCN = c3.Name + i.ToString("00") + "是真的好耶！",
            ...
            for (var i = 0; i < 100; i++)
            {
                var p4 = new Product()
                {
                    ...
                    DSCN = c4.Name + i.ToString("00") + "是真的好耶！",
            ...
            for (var i = 0; i < 50; i++)
            {
                var p5 = new Product()
                {
                    ...
                    DSCN = c5.Name + i.ToString("00") + "是真的好耶！",
            ...
            for (var i = 0; i < 100; i++)
            {
                var p6 = new Product()
                {
                    ...
                    DSCN = c6.Name + i.ToString("00") + "是真的好耶！",

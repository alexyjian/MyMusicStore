...
namespace SEntities
{
    public class Student
    {
        ...
        private string firstName = @"赵,钱,孙,李,周,吴,郑,王,冯,陈,褚,卫,蒋,
        ...
        private string lastName = @"努,迪,立,林,维,吐,丽,新,涛,米,亚,克,湘,明,
        ...
        private string RomName()
        {
            ...
            string[] fNs = firstName.Split(',');
            string[] lNs = lastName.Split(',');
            if (i == 2)
            {
                result = fNs[new Random().Next(0, fNs.Length)] + lNs[new Random().Next(0, lNs.Length)] + lNs[new Random().Next(0, lNs.Length)];
            }
            else
            {
                result = fNs[new Random().Next(0, fNs.Length)] + lNs[new Random().Next(0, lNs.Length)];
            }

    ...
    public class GenreSeed
    {
        ...
        public static void Seed()
        {
            ...
            new List<Album>
            {
                ...
                new Album() { Title="Rock",Genre =genres.Single(g=>g.Name=="摇滚" ),Price=10.8M,Artist=artisrt.Single(a=>a.Name=="Taylor Swift"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Rock",Genre =genres.Single(g=>g.Name=="摇滚" ),Price=3.99M,Artist=artisrt.Single(a=>a.Name=="蔡健雅"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Rock",Genre =genres.Single(g=>g.Name=="摇滚" ),Price=4.99M,Artist=artisrt.Single(a=>a.Name=="蔡健雅"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Jazz",Genre =genres.Single(g=>g.Name=="爵士" ),Price=6.99M,Artist=artisrt.Single(a=>a.Name=="蔡健雅"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Jazz",Genre =genres.Single(g=>g.Name=="爵士" ),Price=2.99M,Artist=artisrt.Single(a=>a.Name=="王以太"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Jazz",Genre =genres.Single(g=>g.Name=="爵士" ),Price=5.99M,Artist=artisrt.Single(a=>a.Name=="王以太"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Jazz",Genre =genres.Single(g=>g.Name=="爵士" ),Price=22.99M,Artist=artisrt.Single(a=>a.Name=="王以太"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Metal",Genre =genres.Single(g=>g.Name=="重金属" ),Price=2.99M,Artist=artisrt.Single(a=>a.Name=="The Chainsmokers"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Metal",Genre =genres.Single(g=>g.Name=="重金属" ),Price=3.99M,Artist=artisrt.Single(a=>a.Name=="Selena Gomez"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Metal",Genre =genres.Single(g=>g.Name=="重金属" ),Price=2.99M,Artist=artisrt.Single(a=>a.Name=="The Chainsmokers"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="K-on",Genre =genres.Single(g=>g.Name=="轻音" ),Price=9.99M,Artist=artisrt.Single(a=>a.Name=="The Chainsmokers"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="K-on",Genre =genres.Single(g=>g.Name=="轻音" ),Price=3.99M,Artist=artisrt.Single(a=>a.Name=="马雨阳"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="K-on",Genre =genres.Single(g=>g.Name=="轻音" ),Price=6.99M,Artist=artisrt.Single(a=>a.Name=="Selena Gomez"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Electric",Genre =genres.Single(g=>g.Name=="电音" ),Price=3.99M,Artist=artisrt.Single(a=>a.Name=="Rihanna"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Electric",Genre =genres.Single(g=>g.Name=="电音" ),Price=2.99M,Artist=artisrt.Single(a=>a.Name=="马雨阳"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Electric",Genre =genres.Single(g=>g.Name=="电音" ),Price=66.99M,Artist=artisrt.Single(a=>a.Name=="张学友"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Electric",Genre =genres.Single(g=>g.Name=="电音" ),Price=899M,Artist=artisrt.Single(a=>a.Name=="张学友"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Reggae",Genre =genres.Single(g=>g.Name=="雷鬼" ),Price=83.99M,Artist=artisrt.Single(a=>a.Name=="五月天"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Reggae",Genre =genres.Single(g=>g.Name=="雷鬼" ),Price=82.99M,Artist=artisrt.Single(a=>a.Name=="张学友"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Reggae",Genre =genres.Single(g=>g.Name=="雷鬼" ),Price=8.99M,Artist=artisrt.Single(a=>a.Name=="五月天"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Rear",Genre =genres.Single(g=>g.Name=="后摇" ),Price=3.99M,Artist=artisrt.Single(a=>a.Name=="张学友"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Rear",Genre =genres.Single(g=>g.Name=="后摇" ),Price=3.99M,Artist=artisrt.Single(a=>a.Name=="五月天"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Rear",Genre =genres.Single(g=>g.Name=="后摇" ),Price=3.99M,Artist=artisrt.Single(a=>a.Name=="胡66"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Popular",Genre =genres.Single(g=>g.Name=="流行" ),Price=2.99M,Artist=artisrt.Single(a=>a.Name=="胡66"),AlbumArtUrl="/Content/images/placeholder.gif" },
                new Album() { Title="Popular",Genre =genres.Single(g=>g.Name=="流行" ),Price=0.99M,Artist=artisrt.Single(a=>a.Name=="Rihanna"),AlbumArtUrl="/Content/images/placeholder.gif" }

   ...
   public  class Order
    {
        ...
        public DateTime OrderDateTme { get; set; } //订单的时间
        public virtual Person Person { get; set; } //所属用户
         public string AddressPeron { get; set; }//收件人
        public string Address { get; set; }//收件人地址
        public string MobilNumber { get; set; } //收件人的手机
       public decimal TotaIPrice { get; set; } //总价
        ...
        {
            ID = Guid.NewGuid();
            OrderDateTme = DateTime.Now;
            TradeNo = OrderDateTme.ToString("yyyMMddhhmmssffff");
        }
    }
}

    ...
    public class StudentSeed
    {
        ...
        public static string _GetRandomChineseFullName(ref string firstName, ref string lasrName)
        {
            string[] _seedFirstName = new string[]
            {
                ...
                "朱","秦","尤","许","何","吕","施","张","孔","邹","喻","柏","水","窦","章","云",
                "苏","潘","葛","奚","范","彭","郎","鲁","韦","昌","马","苗","凤","花","方","俞",
                "任","袁","柳","酆","鲍","史","唐","费","廉","岑","薛","雷","贺","倪","汤","滕",
                "殷","罗","毕","郝","邬","安","常","乐","于","时","傅","皮","卞","齐","康","伍",
                "余","元","卜","顾","孟","平","黄","和","穆","萧","尹","姚","邵","湛","汪","祁",
                "毛","禹","狄","米","贝","明","臧","伏","成","戴","谈","宋","茅","庞","熊","宓",
                "纪","舒","屈","项","祝","董","梁","杜","阮","蓝","闵","席","季","麻","强","贾",
                "路","娄","危","江","童","颜","郭","梅","盛","林","刁","徐","邱","骆","高","宫",
                "夏","蔡","田","樊","胡","凌","霍","虞","万","支","柯","昝","管","卢","莫","经",
                "房","裘","干","解","应","丁","宣","贲","邓","宁","仇","栾","甘","伊","全","郗",
                "历","戎","祖","武","符","刘","郁","单","杭","洪","包","诸","左","石","崔","侯",
                "吉","龚","程","嵇","邢","裴","陆","荣","翁","荀","羊","於","甄","谷","车","牧",
                "麴","家","封","芮","羿","储","靳","邴","松","井","段","富","巫","乌","仲", "巴",
            };

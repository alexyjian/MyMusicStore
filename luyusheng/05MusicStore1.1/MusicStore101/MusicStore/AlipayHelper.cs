...
namespace MusicStore
{
    ...
    public class AlipayHelper
    {
        ...
        public static async Task<bool> VerifyNotiy(string partner,string notifyId)
        {
        ...
        public static IEnumerable<KeyValuePair<string, string>> FilterParameter(IEnumerable<KeyValuePair<string, string>> values)
        {
            return 
                values.Where(t=>t.Key != "sign" && t.Key != "sign_type" && t.Key != "returnUrl" &&

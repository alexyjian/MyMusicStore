...
namespace MusicStore101.Controllers
{
    public class StoreController : Controller
    {
        ...
        public ActionResult showCmts(string pid)
        {
            ...
            htmlString += "<em>楼主&nbsp:</em>" + pcmt.Person.Name + "发表于" + pcmt.CreateDateTime.ToString("yyyy年MM月dd日 hh点mm分ss秒") + ":<br/>" + pcmt.Content;
            htmlString += " </h4> </div>";
        ...
        {
            var genres = _context.Genre.OrderBy(x => x.Name).ToList();
            return View(genres);
        }
    }
}